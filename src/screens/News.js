...
export default function News(props){
    ...
    return(
        <ScrollView>
            ...
            <Button mode="contained" contentStyle={styles.loadMoreContainer} style={styles.loadMore} labelStyle={{color: theme === "dark" ? "#fff" : "#000"}} onPress={() => setPage(page+1)}>{Lang('load_more')}</Button>
        </ScrollView>
    )
}
